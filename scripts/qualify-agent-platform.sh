...
run "generic onboarding, monorepo discovery and prompt-injection boundary" \
  go test ./internal/projectvault -run 'Test(BuildCreatesDeterministicEvidenceBasedProposal|BuildProposesCommandsPerMonorepoModule|BuildTreatsRepositoryTextAsData|ReconcilePreservesChangedRemovedAndUnchangedVaultHistory|ReconcileRejectsCrossRepositoryOrMutableHistory)$' -count=1
