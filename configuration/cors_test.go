...
func TestGetCORSConfigAllowsFrontendRequestHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			rec := performCORSPreflight(e, tt.origin, tt.method, echo.HeaderContentType, echo.HeaderAuthorization, utils.HeaderEventAccessToken)
			...
			for _, header := range []string{echo.HeaderContentType, echo.HeaderAuthorization, utils.HeaderEventAccessToken} {
