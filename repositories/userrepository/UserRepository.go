...
func (r *UserRepo) SetUserRoot(userID uuid.UUID, isRoot bool) error { return SetUserRoot(userID, isRoot) }
func (r *UserRepo) ListAllUsers() ([]models.User, error)            { return ListAllUsers() }
func (r *UserRepo) ListAllUsersPaginated(page, pageSize int) ([]models.User, int64, error) {
	return ListAllUsersPaginated(page, pageSize)
}
